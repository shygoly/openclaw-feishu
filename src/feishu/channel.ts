import type { ChannelMeta, ChannelPlugin, OpenClawConfig } from "../plugin-sdk/index.js";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "../plugin-sdk/index.js";
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount> = {
  ...
  config: {
    ...
    resolveAllowFrom: ({ cfg }) =>
      ((cfg.channels?.feishu as FeishuConfig | undefined)?.allowFrom ?? []).map((entry) =>
        String(entry),
      ),
