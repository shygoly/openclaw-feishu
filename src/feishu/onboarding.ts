...
import { addWildcardAllowFrom, DEFAULT_ACCOUNT_ID, formatDocsLink } from "../plugin-sdk/index.js";
...
type FeishuDmPolicy = "open" | "pairing" | "allowlist";

function setFeishuDmPolicy(cfg: OpenClawConfig, dmPolicy: FeishuDmPolicy): OpenClawConfig {
  const allowFrom =
    dmPolicy === "open"
...
const dmPolicy: ChannelOnboardingDmPolicy = {
  ...
  getCurrent: (cfg) =>
    ((cfg.channels?.feishu as FeishuConfig | undefined)?.dmPolicy ?? "pairing") as DmPolicy,
  setPolicy: (cfg, policy) => setFeishuDmPolicy(cfg, policy as FeishuDmPolicy),
